...
<?php 
	printhtmlpageheader();
?>
  <p align="left"><font color="#494949" size="6">録画ライブラリ番組個別表示</font></p>
  <hr size="4">
...
print "<a href=\"http://cal.syoboi.jp/tid/" .
				     ...
				     htmlspecialchars($title) . "</a> 【<A HREF = \"./folcast.php?tid=$tid\">この番組のFolcast</A>】 <br>\n";
